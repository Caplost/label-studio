...
class ProjectMemberSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ProjectMember
        fields = ['id', 'user', 'user_id', 'project', 'enabled', 'created_at', 'updated_at']
        read_only_fields = ['id', 'project', 'created_at', 'updated_at']


class ProjectContributorListSerializer(serializers.Serializer):
    """Serializer for listing contributors available for a project"""
    user = UserSimpleSerializer(read_only=True)
